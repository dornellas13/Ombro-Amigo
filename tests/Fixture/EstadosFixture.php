...
class EstadosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'uf' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'estados_ibfk_1' => ['type' => 'foreign', 'columns' => ['pais_id'], 'references' => ['pais', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
