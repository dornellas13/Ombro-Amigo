 ...
 <div class="box-left">
  ...
  <div class="box-right">
    ...
    <?= $this->Form->create($solicitacao,['class' => 'col s12','id' => 'formSolicitacao']) ?>
      ...
      <div class="row">
        <?=$this->Html->Link('Voltar',['controller' => 'solicitacoes','action' => 'index'],['class' => 'btn btn-primary'])?>
         <?= $this->Form->button('Salvar <i class="material-icons right">send</i>',['class' => 'btn btn-primary','id' => 'salvar_solicitacao','type' => 'submit']) ?>
